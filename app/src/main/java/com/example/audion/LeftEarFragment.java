    ...
    private void onSave(){
        new Thread(() -> {
            ...
            if (profile == null) {
                ...
                android.util.Log.d("LeftEarFragment", "Creating default HearingProfile with ID: " + profileId);
                ...
                profileId = (int) newId;
                android.util.Log.d("LeftEarFragment", "Created HearingProfile with new ID: " + profileId);
            }
