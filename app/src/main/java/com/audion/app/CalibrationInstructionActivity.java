...
public class CalibrationInstructionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Use the new layout
        setContentView(R.layout.activity_calibration_instruction_new);
    ...
    private void setupUI(String ear) {
        ...
        if (ear.equalsIgnoreCase("LEFT")) {
            title.setText("Left Ear Comfort Volume");
            ...
            title.setText("Right Ear Comfort Volume");
    ...
    private void verifyPureToneCompleted() {
        new Thread(() -> {
            try {
                ...
                com.audion.app.data.HearingTestResultDao hearingTestDao = db.hearingTestResultDao();
