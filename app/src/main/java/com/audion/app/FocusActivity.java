...
import com.audion.app.diarization.SpeakerDiarizationManager;
...
public class FocusActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Keep status bar visible (shows battery indicator)
        // Removed FLAG_FULLSCREEN to maintain consistency with other activities
        ...
        if (noiseRemovalSwitch != null) {
            ...
            SharedPreferences prefs = getSharedPreferences("com.audion.app.PREFERENCES", MODE_PRIVATE);
...
// 2) force one initial tint/layout pass immediately:
    ...
    private void bindAdaptersAndListeners() {
        ...
        enrolledSpeakersAdapter.setOnSpeakerSelectListener((speaker, pos) -> {
            sendBroadcast(new Intent("com.audion.app.STOP_STREAMING"));
...
// attach your threshold-checking listener:
    ...
    private void sendSpeakerIsolationBroadcast(boolean enabled, boolean speakerActive, int chunkId) {
        Intent intent = new Intent("com.audion.app.ACTION_SET_SPEAKER_ISOLATION");
